...
require_once get_template_directory() . '/check-plugins.php';
...
function my_login_head() {
	...
	body.login #login h1 a {
		background: url('".get_stylesheet_directory_uri()."/assets/images/logo.svg') no-repeat scroll center top transparent;
		 width:200px;
	}
	body {background : #fff; }
	.login form {  background:#fff;  border: 6px solid #3498DB;    border-radius: 10px; }
	.login label { color:#3498DB; }
	.login #backtoblog a, .login #nav a {color : #000;}
	.login #backtoblog a:hover, .login #nav a:hover {color : #000;}
